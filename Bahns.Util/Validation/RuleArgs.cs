...
namespace Bahns.Util.Validation
{
	...
	public class RuleArgs
	{
		...
		/// <summary>
		/// User-friendly name for the property to be used instead of
		/// the actual property name when displaying a message to the
		/// user.
		/// </summary>
		public string PropertyDisplayName
		{
			get { return string.IsNullOrEmpty(_propertyDisplayName) ? _propertyName : _propertyDisplayName; }
		}
		...
		/// </summary>
		/// <param name="propertyName">The name of the property to be validated.</param>
		public RuleArgs(string propertyName, string propertyDisplayName)
		{
			_propertyName = propertyName;
