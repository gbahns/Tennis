...
#Region " Public Methods "
    ...
    Public Function GetParameter() As IDataParameter
        Return Library.Data.DataAccess.GetParameter()
    End Function

    Public Function GetParameter(ByVal name As String, ByVal value As Object) As IDataParameter
        Return Library.Data.DataAccess.GetParameter(name, value)
    End Function
    ...
    Public Function GetParameter(ByVal name As String, ByVal value As Object, ByVal direction As ParameterDirection) As IDataParameter
        Dim param As IDataParameter = Library.Data.DataAccess.GetParameter(name, value)
    ...
    Public Function GetParameter(ByVal name As String, ByVal dbType As DbType, ByVal size As Integer, ByVal direction As ParameterDirection) As IDataParameter
        Return Library.Data.DataAccess.GetParameter(name, dbType, size, direction)
    End Function
    ...
    Public Function GetParameter(ByVal name As String, ByVal dbType As DbType, ByVal size As Integer, ByVal sourceColumn As String, ByVal sourceVersion As DataRowVersion) As IDataParameter
        Return Library.Data.DataAccess.GetParameter(name, dbType, size, sourceColumn, sourceVersion)
    End Function
    ...
    Public Function ExecFunction(ByVal funcName As String, ByVal ParamArray parameters() As IDataParameter) As Object
        Return Library.Data.DataAccess.ExecFunction(connString, funcName, parameters)
    End Function
    ...
    Public Function ExecFunction(ByVal funcName As String, ByVal ParamArray parameterValues() As Object) As Object
        Dim parameters As IDataParameter() = Library.Data.DataAccess.GetParameters(connString, funcName)
        PopulateParameterValues(parameters, parameterValues)
        Dim result As Object = Library.Data.DataAccess.ExecFunction(connString, funcName, parameters)
        Return result
    End Function
    ...
    ''' </remarks>
    '''===================================================================================================
	Public Function ExecReader(ByVal procName As String) As IDataReader
		Dim parameters As IDataParameter() = Library.Data.DataAccess.GetParameters(connString, procName)
		'Dim reader As IDataReader = 
		Return Library.Data.DataAccess.ExecReader(connString, procName, parameters)
    ...
    ''' </remarks>
    '''===================================================================================================
	Public Function ExecReader(ByVal procName As String, ByVal ParamArray parameters() As IDataParameter) As IDataReader
		'Dim reader As IDataReader = 
		Return Library.Data.DataAccess.ExecReader(connString, procName, parameters)
		'Return New SafeDataReader(reader)
	End Function
    ...
    ''' </remarks>
    '''===================================================================================================
	Public Function ExecReader(ByVal procName As String, ByVal ParamArray parameterValues() As Object) As IDataReader
		Dim parameters As IDataParameter() = Library.Data.DataAccess.GetParameters(connString, procName)
		PopulateParameterValues(parameters, parameterValues)
		'Dim reader As IDataReader = 
		Return Library.Data.DataAccess.ExecReader(connString, procName, parameters)
    ...
    Public Function ExecDataSet(ByVal procName As String) As DataSet
        Return Library.Data.DataAccess.ExecDataSet(connString, procName)
    End Function
    ...
    Public Function ExecDataSet(ByVal procName As String, ByVal ParamArray parameters() As IDataParameter) As DataSet
        Return Library.Data.DataAccess.ExecDataSet(connString, procName, parameters)
    End Function
    ...
    Public Function ExecUpdate(ByVal procName As String, ByVal ParamArray parameters() As IDataParameter) As Hashtable
        ...
        If Transaction Is Nothing Then
            rows = Library.Data.DataAccess.ExecUpdate(connString, procName, parameters)
        Else
            rows = Library.Data.DataAccess.ExecUpdate(Transaction, procName, parameters)
        End If
    ...
    Public Sub BeginTransaction()
        ...
        End If
        Transaction = Library.Data.DataAccess.BeginTransaction(connString)
    End Sub
