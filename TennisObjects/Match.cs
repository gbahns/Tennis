...
namespace TennisObjects
{
	...
	/// </remarks> 
	[Serializable()]
	public class Match : BusinessBase<Match>
	{
		...
		private bool WinnerNotLoser(object target, Csla.Validation.RuleArgs e)
		{
		...
		public override List<BrokenRule> GetAllBrokenRules()
		{
			...
			foreach (BrokenRule rule in _Score.GetAllBrokenRules())
				rules.Add(rule);
			return rules;
		}
