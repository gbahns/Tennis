...
{
	[Serializable()]
	public class PlayerOpponentSummary : ReadOnlyBase<PlayerEventSummary>
	{
		...
		public static PlayerOpponentSummary GetPlayerOpponentSummary(SafeDataReader dr)
		{
		...
		public static PlayerOpponentSummary GetTotal(PlayerOpponentSummaryList list)
		{
